/**\file */
#ifndef SLIC_DECLARATIONS_MovingAverage_H
#define SLIC_DECLARATIONS_MovingAverage_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define MovingAverage_PCIE_ALIGNMENT (16)
 ...
 */
max_run_t *MovingAverage_nonblock(
	int32_t param_N,
	const float *instream_x,
	float *outstream_y);
 ...
 */
max_run_t *MovingAverage_run_nonblock(
	max_engine_t *engine,
	MovingAverage_actions_t *interface_actions);
 ...
 */
void MovingAverage_run_group(max_group_t *group, MovingAverage_actions_t *interface_actions);
 ...
 */
max_actions_t* MovingAverage_convert(max_file_t *maxfile, MovingAverage_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* MovingAverage_init(void);

/* Error handling functions */
int MovingAverage_has_errors(void);
const char* MovingAverage_get_errors(void);
void MovingAverage_clear_errors(void);
/* Free statically allocated maxfile data */
void MovingAverage_free(void);
/* returns: -1 = error running command; 0 = no error reported */
int MovingAverage_simulator_start(void);
/* returns: -1 = error running command; 0 = no error reported */
int MovingAverage_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_MovingAverage_H */
